...
input_interim <- read_csv2(file = here::here("data", "RAW", "Vangstgegevens_muskus_en_beverratten_NL_2019.csv"))                        
...
###identifiedBy
```{r}
occurrence %<>% mutate(identifiedBy = 'NL_Waterschappen')
```
...
occurrence %<>% select(-c(CatchTypeName))  #remove collection columns
